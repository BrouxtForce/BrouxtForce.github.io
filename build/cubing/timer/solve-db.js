async function addToObjectStore(db, objectStoreName, data) {
...
async function deleteFromObjectStore(db, objectStoreName, key) {
    return new Promise((resolve, reject) => {
        let transaction = db.transaction(objectStoreName, "readwrite");
        let objectStore = transaction.objectStore(objectStoreName);
...
async function getFromObjectStore(db, objectStoreName, key) {
    return new Promise((resolve, reject) => {
