...
// IndexedDB Helpers
async function addToObjectStore(db: IDBDatabase, objectStoreName: string, data: any): Promise<void> {
...
async function deleteFromObjectStore(db: IDBDatabase, objectStoreName: string, key: IDBValidKey | IDBKeyRange): Promise<void> {
    return new Promise<void>((resolve, reject) => {
        let transaction = db.transaction(objectStoreName, "readwrite");
        let objectStore = transaction.objectStore(objectStoreName);
...
async function getFromObjectStore(db: IDBDatabase, objectStoreName: string, key: IDBValidKey | IDBKeyRange): Promise<any> {
    return new Promise<void>((resolve, reject) => {
